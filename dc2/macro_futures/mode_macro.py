...
from dc2.macro_futures.config import FUTURES
...
def run_macro_analysis(lookback_days: int = 5) -> dict[str, Any]:
    ...
    for symbol in FUTURES:
        ...
        daily_for_targets = _filter_bars_before(bars_dict.get("1d", []), cutoff_bp_dt)
        ...
        dist_overnight_pct = round((precio_actual - bp_f) / bp_f * 100, 3) if bp_f else 0.0
